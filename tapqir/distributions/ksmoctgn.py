...
class KSMOCTGN(TorchDistribution):
    r"""
    K-Spots Marginalized Offset Cross-Talk Gamma Noise Image Distribution.
    ...
    **Reference**:
    ...
    :param crosstalk: Cross talk between color channels.
    ...
    def __init__(
        ...
        #  crosstalk_gaussians = (
        #      torch.flip(gaussians, (-4,)) * crosstalk[..., None, None, None]
        #  )

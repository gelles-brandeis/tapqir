    ...
    def spot_guide(self, data, prefix):
        ...
        with aois as ndx:
            ...
            with frames as fdx:
                ...
                z_loc, z_scale = self.encoder(obs)
                ...
                for kdx in spots:
                    ...
                    with handlers.mask(mask=m > 0):
                        ...
                        pyro.sample(
                            f"{prefix}/height_{kdx}",
                            dist.Gamma(
                                z_loc[..., kdx] * z_scale[..., kdx], z_scale[..., kdx]
...
class CosmosVAE(CosmosVAEMarginal):
    """
    Time-independent Single Molecule Colocalization Model.
    """
    ...
    def init_parameters(self):
        ...
        self.load_checkpoint(
            path=self.path / "marginalvae" / tapqir_version.split("+")[0],
            param_only=True,
            warnings=True,
        )

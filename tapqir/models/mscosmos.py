    ...
    **Reference**:
    ...
    def init_parameters(self):
        ...
        checkpoint = torch.load(
            self.run_path / f"cosmos-channel{self.cdx}-model.tpqr", map_location=device
        )
        ...
        pyro.param(
            ...
            lambda: torch.tensor([1500, 3000], device=device),

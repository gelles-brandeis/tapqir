...
python -i run.py --num-epochs=100 --model=junk --n-batch=16 --learning-rate=0.0005 --dataset=LarryCy3sigma54 --cuda0
#python -i run.py --num-epochs=100 --model=v6 --n-batch=16 --learning-rate=0.001 --dataset=Irenecy5 --cuda1
#python -i run.py --num-epochs=100 --model=junk --n-batch=16 --learning-rate=0.0005 --dataset=Gracecy3 --cuda0

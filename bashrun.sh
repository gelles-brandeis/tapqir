...
#python run.py --num-epochs=20000 --model=features --n-batch=32 --learning-rate=0.001 --dataset=GraceArticlePol2 --negative-control=GraceArticlePol2NegativeControl --cuda0
...
#python run.py --num-epochs=10000 --model=detector --n-batch=16 --learning-rate=0.003 --dataset=LarryCy3sigma54Short --negative-control=LarryCy3sigma54NegativeControlShort --cuda1
#python run.py --num-epochs=10000 --model=detector --n-batch=16 --learning-rate=0.001 --dataset=LarryCy3sigma54Short --negative-control=LarryCy3sigma54NegativeControlShort --cuda1
#python run.py --num-epochs=10000 --model=detector --n-batch=16 --learning-rate=0.0003 --dataset=LarryCy3sigma54Short --negative-control=LarryCy3sigma54NegativeControlShort --cuda1
#python run.py --num-epochs=10000 --model=detector --n-batch=16 --learning-rate=0.0002 --dataset=LarryCy3sigma54Short --negative-control=LarryCy3sigma54NegativeControlShort --cuda1

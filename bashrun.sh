...
python -i run.py --num-epochs=50000 --model=v12 --n-batch=16 --learning-rate=0.001 --dataset=LarryCy3sigma54 --cuda1
...
#python -i run.py --num-epochs=50000 --model=v11 --n-batch=64 --learning-rate=0.005 --dataset=Gracecy3 --cuda0

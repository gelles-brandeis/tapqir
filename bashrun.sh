...
python -i run.py --model=features --n-batch=16 --learning-rate=0.0005 --dataset=LarryCy3sigma54 --negative-control=LarryCy3sigma54NegativeControl --cuda1
...
#python -i run.py --num-epochs=30000 --model=tracker --n-batch=32 --learning-rate=0.0005 --dataset=GraceArticlePol2 --cuda0

...
class Tracker(Model):
    ...
    def model_parameters(self):
        ...
        param("height_loc", torch.tensor([100., 100.]), constraint=constraints.positive)
        param("height_beta", torch.tensor([1., 1.]), constraint=constraints.positive)
        param("width_loc", torch.tensor([1.3, 1.3]), constraint=constraints.positive)
        param("width_beta", torch.tensor([10., 10.]), constraint=constraints.positive)
        #param("width_loc", torch.tensor([1.3]), constraint=constraints.positive)
        #param("width_beta", torch.tensor([10.]), constraint=constraints.positive)

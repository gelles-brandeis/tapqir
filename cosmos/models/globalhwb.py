            ...
            with F_plate:
                ...
                pyro.sample(
                    "data", ConvGamma(
                        ...
                        data.offset_samples, data.offset_weights.log()
                    ).to_event(2),
                    obs=data[batch_idx])

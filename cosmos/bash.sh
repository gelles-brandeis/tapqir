...
#python main.py --num-iter=20000 --model=tracker --n-batch=16 --learning-rate=0.0015 --dataset=FL_4445_5554_1p1OD_atten --device=cuda1 --jit
#python main.py --num-iter=20000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_5555_6684_1p3OD_atten --device=cuda1 --jit
#python main.py --num-iter=20000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_5555_6684_1p3OD --device=cuda0 --jit

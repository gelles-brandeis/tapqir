...
test: lint FORCE
	...
	python examples/cosmos_simulations.py --gain 7 --pi 0.15 --lamda 0.15 \
		--proximity 0.2 --height 3000 -N 2 -F 5 -it 1
	python examples/cosmos_simulations.py -N 2 -F 5 -it 1
	python examples/kinetic_simulations.py -N 2 -F 5 -it 1
	# python examples/cosmos_simulations.py --gain 7 --pi 0.15 --lamda 0.15 \
...
test-cuda: lint FORCE
	python examples/cosmos_simulations.py --gain 7 --pi 0.15 --lamda 0.15 \
		--proximity 0.2 --height 3000 -N 2 -F 5 -it 1 --cuda
	python examples/cosmos_simulations.py -N 2 -F 5 -it 1 --cuda
	python examples/kinetic_simulations.py -N 2 -F 5 -it 1 --cuda
	# python examples/cosmos_simulations.py --gain 7 --pi 0.15 --lamda 0.15 \

...
cosmos --num-steps=25000 --model=tracker --n-batch=32 --learning-rate=0.005 --dataset=FL_1_1117_0OD --negative-control=FL_1_1117_0OD.NegativeControl --device=cuda0
cosmos --num-steps=25000 --model=tracker --n-batch=32 --learning-rate=0.005 --dataset=FL_1118_2225_0p3OD --negative-control=FL_1118_2225_0p3OD.NegativeControl --device=cuda1

...
python main.py --num-steps=25000 --model=tracker --n-batch=32 --learning-rate=0.0049 --dataset=FL_1_1117_0OD --negative-control=FL_1_1117_0OD.NegativeControl --device=cuda0

...
#python main.py --num-steps=10000 --model=tracker --n-batch=32 --learning-rate=0.005 --dataset=GraceArticlePol2 --device=cuda1
...
python main.py --num-steps=20000 --model=marginal --n-batch=16 --learning-rate=0.005 --dataset=LarryCy3sigma54Short --device=cuda0
#python main.py --num-steps=10000 --model=tracker --n-batch=16 --learning-rate=0.006 --dataset=LarryCy3sigma54Short --device=cuda0

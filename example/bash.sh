...
python main.py --num-steps=50000 --model=tracker --n-batch=32 --learning-rate=0.0051 --dataset=GraceArticlePol2 --device=cuda1
...
#python main.py --num-steps=10000 --model=tracker --n-batch=16 --learning-rate=0.005 --dataset=LarryCy3sigma54Short --device=cuda0

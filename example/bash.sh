...
python main.py --num-steps=100000 --model=tracker --n-batch=32 --learning-rate=0.001 --dataset=Gracecy3 --device=cuda1
#python main.py --num-iter=20000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_1_1117_0OD_atten --device=cuda1 --jit
#python main.py --num-iter=20000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_1118_2225_0p3OD_atten --device=cuda1 --jit
#python main.py --num-iter=20000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_2226_3338_0p6OD_atten --device=cuda1 --jit
#python main.py --num-iter=20000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_3339_4444_0p8OD_atten --device=cuda1 --jit
#python main.py --num-iter=20000 --model=tracker --n-batch=16 --learning-rate=0.0015 --dataset=FL_4445_5554_1p1OD_atten --device=cuda0 --jit
...
#python main.py --num-iter=20000 --model=tracker --n-batch=16 --learning-rate=0.0015 --dataset=FL_4445_5554_1p1OD --device=cuda1 --jit
#python main.py --num-iter=1000 --model=tracker --n-batch=32 --learning-rate=0.003 --dataset=FL_5555_6684_1p3OD --device=cuda1 --jit

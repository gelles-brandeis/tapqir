...
python main.py --num-steps=20000 --model=marginal --n-batch=32 --learning-rate=0.01 --dataset=GraceArticlePol2 --device=cuda1
...
#python main.py --num-steps=25000 --model=marginal --n-batch=16 --learning-rate=0.01 --dataset=LarryCy3sigma54Short --device=cuda0

...
#python main.py --num-steps=30000 --model=marginal --n-batch=32 --learning-rate=0.008 --dataset=GraceArticlePol2 --device=cuda1
python main.py --num-steps=30000 --model=tracker --n-batch=32 --learning-rate=0.0055 --dataset=GraceArticlePol2 --device=cuda1
...
#python main.py --num-steps=20000 --model=marginal --n-batch=16 --learning-rate=0.008 --dataset=LarryCy3sigma54Short --device=cuda0
#python main.py --num-steps=10000 --model=tracker --n-batch=16 --learning-rate=0.004 --dataset=LarryCy3sigma54Short --device=cuda0
#python main.py --num-steps=30000 --model=tracker --n-batch=32 --learning-rate=0.005 --dataset=GraceArticlePol2NegativeControl2 --negative-control=GraceArticlePol2NegativeControl1 --device=cuda1

...
python main.py --num-steps=25000 --model=marginal --n-batch=32 --learning-rate=0.005 --dataset=FL_1_1117_0OD_atten --negative-control=FL_1_1117_0OD_atten.NegativeControl --device=cuda1
